...
public class ClickablePolygon extends OverlayWithIW {
    ...
    public ClickablePolygon(MapView mapView) {
        if (mapView != null) {
     ...
     */
    public static ArrayList<GeoPoint> pointsAsRect(BoundingBox rectangle) {
    ...
    /**
     * Important note: this function returns correct results only if the ClickablePolygon has been drawn before,
     * and if the MapView positioning has not changed.
     *
     * @param event
     * @return true if the ClickablePolygon contains the event position.
     */
    ...
    /**
     * Default listener for a single tap event on a ClickablePolygon:
...
//                return onClickDefault(this, mapView, eventPos);
    ...
    public void setOnlongClickListener(ClickablePolygon.OnLongClickListener onlongClickListener) {
        this.onlongClickListener = onlongClickListener;
    }

    public interface OnLongClickListener {
        abstract boolean onLongClick(ClickablePolygon polyline, MapView mapView, GeoPoint eventPos);
    }
    ...
    //-- ClickablePolygon events listener interfaces ------------------------------------

    public interface OnClickListener {
        boolean onClick(ClickablePolygon polygon, MapView mapView, GeoPoint eventPos);
    }

    /**
     * default behaviour when no click listener is set
     */
    public boolean onClickDefault(ClickablePolygon polygon, MapView mapView, GeoPoint eventPos) {
     ...
     * @since 6.0.2
     */
    public void setOnClickListener(ClickablePolygon.OnClickListener listener) {
