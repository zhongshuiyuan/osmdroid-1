...
public abstract class MapTileModuleProviderBase {
    ...
    public MapTileModuleProviderBase(int pThreadPoolSize, final int pPendingQueueSize) {
        ...
        mExecutor = new ThreadPoolExecutor(pThreadPoolSize, Configuration.getInstance().getTileDownloadMaxQueueSize(), 30, TimeUnit.MINUTES, new LinkedBlockingQueue<Runnable>(), new ConfigurablePriorityThreadFactory(Thread.NORM_PRIORITY, getThreadGroupName()));
