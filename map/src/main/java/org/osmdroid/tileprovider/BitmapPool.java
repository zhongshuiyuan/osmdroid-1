...
public class BitmapPool {
    ...
    private final ExecutorService mExecutor = new ThreadPoolExecutor(1, 3, 30, TimeUnit.MINUTES, new LinkedBlockingQueue<Runnable>(), new ConfigurablePriorityThreadFactory(Thread.MIN_PRIORITY, getClass().getName()));
