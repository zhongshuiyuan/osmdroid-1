...
public class RadiusMarkerClusterer extends MarkerClusterer {
    ...
    public RadiusMarkerClusterer(Context ctx) {
        ...
        Drawable clusterIconD = ctx.getResources().getDrawable(R.drawable.marker_default);
    ...
    public void renderer(ArrayList<StaticCluster> clusters, Canvas canvas, MapView mapView) {
        for (StaticCluster cluster : clusters) {
            if (cluster.getSize() == 1) {
                ...
                //only draw 1 TextMarker at Cluster center, displaying number of Markers contained
