package org.bonuspack.clustering;
 ...
 * Usage: put your markers inside with add(TextMarker), and add the MarkerClusterer to the map overlays.
 * Depending on the zoom level, markers will be displayed separately, or grouped as a single TextMarker. <br/>
 * 
...
public abstract class MarkerClusterer extends Overlay {
	...
	/** @return the TextMarker at projectId (starting at 0) */
