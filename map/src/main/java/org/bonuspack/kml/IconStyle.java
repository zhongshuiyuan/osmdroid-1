...
import org.bonuspack.utils.WebImageCache;
...
public class IconStyle extends ColorStyle implements Parcelable {
	...
	/** apply all IconStyle attributes to the TextMarker */
	public void styleMarker(Marker marker, Context context){
		...
		//Y coords are top->bottom for TextMarker Anchor, and bottom->up for KML hotSpot
