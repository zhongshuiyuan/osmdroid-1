...
public abstract class KmlGeometry implements Cloneable, Parcelable {
	...
	/** KML projectId attribute, if any. Null if none. */
	public String mId;
	...
	public abstract Overlay buildOverlay(MapView map, Style defaultStyle, KmlFeature.Styler styler, KmlPlacemark kmlPlacemark, KmlDocument kmlDocument);
