...
import org.bonuspack.clustering.MarkerClusterer;
import org.bonuspack.overlays.GroundOverlay;
...
public class KmlFolder extends KmlFeature implements Cloneable, Parcelable {
    ...
    public boolean addOverlay(Overlay overlay, KmlDocument kmlDoc) {
        ...
        if (overlay instanceof GroundOverlay) {
            ...
            marker.setTextIcon(marker.getTitle());
    ...
    /**
     * Find a feature with a specific projectId in the folder.
     *
     * @param id      feature projectId to find.
