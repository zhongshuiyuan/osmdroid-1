...
import org.bonuspack.utils.BonusPackHelper;
import org.bonuspack.utils.GISUtils;
import org.bonuspack.utils.HttpConnection;
...
public class KmlDocument implements Parcelable {
    ...
    public static void setTranslate(boolean trans) {
        translate = trans;
    }
    ...
    protected static GeoPoint parseKmlCoord(String input) {
        ...
        try {
            if (end2 == -1) {
                ...
                if (translate) {
                    double[] d = GISUtils.transform(lat, lon);
                ...
                if (translate) {
                    double[] d = GISUtils.transform(lat, lon);
                    return new GeoPoint(d[0], d[1], alt);
                }
    ...
    protected enum KmlKeywords {
        Document, Folder, NetworkLink, GroundOverlay, Placemark, Point, LineString, gx_Track,
        ...
        colorMode, width, scale, heading, href, north, south, east, west, rotation, LatLonBox, value, OvStyle, TrackStyle
    }
    ...
    static {
        ...
        //奥维的标签
        KEYWORDS_DICTIONARY.put("TrackStyle", KmlKeywords.TrackStyle);
        KEYWORDS_DICTIONARY.put("OvStyle", KmlKeywords.OvStyle);
    }
            ...
            if (element != null) {
                switch (element) {
                    case Document: {
                        ...
                        mKmlCurrentFeature.mId = attributes.getValue("projectId");
                        break;
                    }
                    case Folder: {
                    ...
                    case Style: {
                        ...
                        mCurrentStyleId = attributes.getValue("projectId");
                        break;
                    }
                    case StyleMap: {
            ...
            switch (element) {
                ...
                case Style: {
                    ...
                    if (mKmlCurrentFeature != null && mKmlCurrentFeature != mKmlRoot) {
                        //this is an inline style. Set its style projectId to the KmlObject container:
