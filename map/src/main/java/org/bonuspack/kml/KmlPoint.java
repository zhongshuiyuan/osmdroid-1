...
public class KmlPoint extends KmlGeometry implements Parcelable, Cloneable {
    ...
    /**
     * default listener for dragging a TextMarker built from a KML Point
     */
    ...
    /**
     * Build the corresponding TextMarker overlay
     */
    @Override
    public Overlay buildOverlay(MapView map, Style defaultStyle, KmlFeature.Styler styler, KmlPlacemark kmlPlacemark,
        ...
        marker.setTextIcon(kmlPlacemark.mName);
        return marker;
    }
