 ...
 */
public class AddInterchangeDialog extends BaseDialog {
    ...
    private AddInterchangeDialog(Context context) {
    ...
    private static AddInterchangeDialog dialog;

    public static AddInterchangeDialog getInstance(Context context) {
        if (null == dialog) {
            dialog = new AddInterchangeDialog(context);
        }
        return dialog;
    }
    ...
    public void onCreateDialog(Bundle savedInstanceState) {
        setContentView(R.layout.dialog_add_interchange);
        ...
        tv_confirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(name)) {
                    ToastUtils.showShortToast("互通立交名称不能为空");
                    return;
                }
                if (null != onClick) {
