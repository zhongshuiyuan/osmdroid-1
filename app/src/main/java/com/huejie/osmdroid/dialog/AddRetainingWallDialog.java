 ...
 */
public class AddRetainingWallDialog extends BaseDialog {
    private Context context;

    private EditText et_qdzh;
    private EditText et_zdzh;
    ...
    private AddRetainingWallDialog(Context context) {
    ...
    private static AddRetainingWallDialog dialog;

    public static AddRetainingWallDialog getInstance(Context context) {
        if (null == dialog) {
            dialog = new AddRetainingWallDialog(context);
        }
        return dialog;
    }
    ...
    public void onCreateDialog(Bundle savedInstanceState) {
        setContentView(R.layout.dialog_add_retaining_wall);
        et_qdzh = findViewById(R.id.et_qdzh);
        et_zdzh = findViewById(R.id.et_zdzh);
        ...
        String[] data = DictUtil.getDictLabels(context, DictUtil.WALL_TYPE);
        list = new ArrayList<>();
        ...
        tv_confirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(qdzh)) {
                    ToastUtils.showShortToast("起点桩号不能为空");
                    return;
                }
                String zdzh = et_zdzh.getText().toString().trim();
                if (TextUtils.isEmpty(zdzh)) {
                    ToastUtils.showShortToast("终点桩号不能为空");
                    return;
                }
                if (TextUtils.isEmpty(wallType)) {
                    ToastUtils.showShortToast("挡墙类型不能为空");
                    return;
                }
                if (null != onClick) {
                    onClick.onConfirm(qdzh, zdzh, wallType);
                }
            }
        });
    ...
    public static interface OnClick {
         ...
         * 确定操作
         */
        void onConfirm(String startStake, String endStake, String wallType);
