...
public class AlongTheLineDrainageSystemRecordBookFragment extends BookBaseFragment {
    ...
    public AlongTheLineDrainageSystemRecordBookFragment() {
        // Required empty public constructor
    }

    public static AlongTheLineDrainageSystemRecordBookFragment newInstance(BookSimple param1, String param2) {
        AlongTheLineDrainageSystemRecordBookFragment fragment = new AlongTheLineDrainageSystemRecordBookFragment();
