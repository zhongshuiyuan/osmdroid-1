...
public class RetainingWallRecordBookFragment extends BookBaseFragment {
    ...
    public RetainingWallRecordBookFragment() {
        // Required empty public constructor
    }

    public static RetainingWallRecordBookFragment newInstance(BookSimple param1, String param2) {
        RetainingWallRecordBookFragment fragment = new RetainingWallRecordBookFragment();
