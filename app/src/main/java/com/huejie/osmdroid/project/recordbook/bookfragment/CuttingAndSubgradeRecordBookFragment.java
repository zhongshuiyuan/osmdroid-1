...
public class CuttingAndSubgradeRecordBookFragment extends BookBaseFragment {
    ...
    public CuttingAndSubgradeRecordBookFragment() {
        // Required empty public constructor
    }

    public static CuttingAndSubgradeRecordBookFragment newInstance(BookSimple param1, String param2) {
        CuttingAndSubgradeRecordBookFragment fragment = new CuttingAndSubgradeRecordBookFragment();
