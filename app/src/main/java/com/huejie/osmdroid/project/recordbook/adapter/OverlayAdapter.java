...
public class OverlayAdapter extends BaseAdapter {
    private List<CommonProjectMedia> data;
    private LayoutInflater inflater;
    private Context context;

    public OverlayAdapter(Context context, List<CommonProjectMedia> data) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        CommonProjectMedia bean = data.get(position);
        holder.ctv_tag.setText(bean.mediaName);
