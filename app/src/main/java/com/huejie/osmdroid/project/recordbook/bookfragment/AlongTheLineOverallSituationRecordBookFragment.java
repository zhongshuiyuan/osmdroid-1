...
public class AlongTheLineOverallSituationRecordBookFragment extends BookBaseFragment {
    ...
    public AlongTheLineOverallSituationRecordBookFragment() {
        // Required empty public constructor
    }

    public static AlongTheLineOverallSituationRecordBookFragment newInstance(BookSimple param1, String param2) {
        AlongTheLineOverallSituationRecordBookFragment fragment = new AlongTheLineOverallSituationRecordBookFragment();
