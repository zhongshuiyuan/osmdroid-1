...
public class TunnelEngineeringRecordBookFragment extends BookBaseFragment {
    ...
    public TunnelEngineeringRecordBookFragment() {
        // Required empty public constructor
    }

    public static TunnelEngineeringRecordBookFragment newInstance(BookSimple param1, String param2) {
        TunnelEngineeringRecordBookFragment fragment = new TunnelEngineeringRecordBookFragment();
