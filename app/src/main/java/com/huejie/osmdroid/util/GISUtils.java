...
public class GISUtils {
    ...
    public static BoundingBox getMbtilesBoundingBox(File file) {
        ...
        final Cursor cur = mDatabase.query("metadata", new String[]{"value"}, "favoritesName=?", new String[]{"bounds"}, null, null, null);
    ...
    public static boolean judgeMapNeedCorrection(ITileSource tileSource) {
        return !(tileSource instanceof TianDiTuTileSource);
    }
