...
public class FluentQuery {
    ...
    public int count(Class<?> modelClass) {
        ...
        try {
            Table table = Class.forName(modelClass.getName()).getAnnotation(Table.class);
            if (null != table) {
                className = table.value();
                return count(BaseUtility.changeCase(className));
            }
    ...
    public CountExecutor countAsync(Class<?> modelClass) {
        ...
        try {
            ...
            if (null != table) {
                className = table.value();
                return countAsync(BaseUtility.changeCase(className));
            }
